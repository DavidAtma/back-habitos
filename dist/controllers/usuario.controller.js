...
exports.listarUsuario = exports.insertarUsuario = void 0;
...
const insertarUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield usuarioService.insertarUsuario(usuario);
...
const listarUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const usuarios = yield usuarioService.listarUsuario();
