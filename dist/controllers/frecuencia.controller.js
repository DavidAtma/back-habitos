...
const frecuenciaService = __importStar(require("../services/frecuencia.service"));
const base_response_1 = require("../shared/base-response");
const constants_1 = require("../shared/constants");
const insertarFrecuencia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const frecuencia = req.body;
        yield frecuenciaService.insertarFrecuencia(frecuencia);
...
const listarFrecuencia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const frecuencias = yield frecuenciaService.listarFrecuencia();
...
//# sourceMappingURL=frecuencia.controller.js.map